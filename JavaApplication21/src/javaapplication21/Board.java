...
public class Board {
    ...
    /**
     * private helper method that fills empty rows between specified low and
     * high rows
	 *
     */
    ...
    /**
     * private helper method that copies a single row If the rowFrom parameter
     * is more than the max row index specified by maxHeight, then empty the row
     * pointed by rowTo.
	 *
     */
